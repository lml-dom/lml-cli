...
import { parseHTML } from 'html-lml';
import { OutputConfig, ParseConfig, ParseError, ParserInterface, parseAST, parseJSON, parseLML } from 'lml';
...
new CLI(minimist(process.argv.slice(2), {boolean: true}));
